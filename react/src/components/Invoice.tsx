...
function Invoice({invoiceData, setShowInvoice}: Props) {
    ...
    return (
        <div style={{position: "fixed", left: 0, top: "30px", display: "flex", justifyContent: "center", flexDirection: "row", width: "100vw"}}>
            { (!formFilled) ?
                <div className="popup">
                ...
                :
                <>
                    <button onClick={() => setShowInvoice(false)} style={{position: "fixed", left: 0, top: "87px", height: "34px", backgroundColor: "#323639", border: "none", borderRadius: "0 0 1em 0", boxShadow: "-0px -5px 0px #323639, 0px 0px 4px black"}}>
